...
export default function StickyBookBar({ dict }: { dict: Dict }) {
  ...
  return (
    <div
      aria-hidden={!show}
      className={`fixed inset-x-0 bottom-0 z-40 border-t border-forest-800 bg-forest-950/95 backdrop-blur-lg transition-transform duration-500 ease-smooth md:hidden ${
