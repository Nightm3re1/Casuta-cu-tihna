...
export const en: Dict = {
  ...
  hero: {
    eyebrow: 'Porumbacu de Sus · Foot of the Făgăraș',
    ...
    animationLabel:
      'Animation: the 1923 cottage rises from an architect’s drawing into a finished house as you scroll the page.',
    stats: [
  ...
  amenities: {
    eyebrow: 'What’s here',
    title: 'Everything you get, with no surprises.',
  ...
  reviews: {
    eyebrow: 'Guests',
    title: 'What people say once they’ve left.',
    lede: 'Reviews written by guests who actually stayed here.',
    sourceLabel: 'Source',
  ...
  faq: {
    eyebrow: 'Questions',
    title: 'The things you write to ask us most.',
  ...
  finalCta: {
    eyebrow: 'Book',
    title: 'The good weekends go two months ahead.',
    lede:
  ...
  footer: {
    blurb: 'A cottage from 1923, restored and let whole, at the foot of the Făgăraș mountains.',
    nav: 'Navigate',
    contact: 'Contact',
    book: 'Book',
